...
function dpIsMobile(){
    var ua = __UA;
    var ism = /mobile/i.test(ua);
    if(!ism){
        ism = !!ua.match(/(iPhone|iPod|Android|ios)/i);
    }
    return ism;
}
function MobileAddStyle(){
    if(dpIsMobile()){
