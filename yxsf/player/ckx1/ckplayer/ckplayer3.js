				...
				if (isVideoH5 != null && thisPd != null) {
					...
					if (!this.isM3u8) {
						...
						if(vtype){
							...
							html = '<video'+html_muted+' id="' + vid + '"' + ' width="100%" height="100%"' + autoplay + poster + loop + preload + controls + mobileautofull + track + '>' + v_source + '</video>';
						}else {
							html = '<video'+html_muted+' id="' + vid + '"' + src + ' width="100%" height="100%"' + autoplay + poster + loop + preload + controls + mobileautofull + track + '>' + source + '</video>';
						}
					} else {
						html = '<video'+html_muted+' id="' + vid + '" width="100%" height="100%"' + poster + loop + preload + controls + mobileautofull + track + '></video>';
					}
